...
- [Payload](#Payload)
- [Cookies](#Cookies)
- [TCP/IP Networking for Developers](#TCP/IP-Networking-for-Developers)
...
# 3. TCP/IP Networking for Developers
### 3.1 IP Addresses
...
#### 3.2 Name Resolution
##### 3.2.1 using nslookup on the command line
